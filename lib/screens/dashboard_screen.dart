...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Create Trip button at the bottom
      floatingActionButton: _currentIndex == 0
          ...
          : null,
      // Trips, Explore, and Profile icons at bottom
...
// Explore tab (placeholder, potentially push to separate explore screen in future)
...
// Profile tab (pushes to full profile screen)
